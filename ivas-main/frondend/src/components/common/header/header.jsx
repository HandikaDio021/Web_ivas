            ...
            <header className="app-header">
                ...
                <div className="main-header-container container-fluid">
                    <div className="header-content-left">
                        ...
                        <div className="header-element">
                            <label className="sidemenu-toggle header-link">Project </label>
                        </div>
                    ...
                    <div className="header-content-right">
                        ...
                        <Dropdown className="header-element header-profile">
                            ...
                            <Dropdown.Menu align="end" as="ul" className="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                                ...
                                {/* <Dropdown.Item className="d-flex" href="#"><i className="ti ti-inbox fs-18 me-2 op-7"></i>Inbox <span className="badge bg-success-transparent ms-auto">25</span></Dropdown.Item>
                                <Dropdown.Item className="d-flex border-block-end" href="#"><i className="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task Manager</Dropdown.Item>
                                <Dropdown.Item className="d-flex" href="#"><i className="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</Dropdown.Item>
                                ...
                                <Dropdown.Item className="d-flex" href="#"><i className="ti ti-headset fs-18 me-2 op-7"></i>Support</Dropdown.Item> */}
                                <Dropdown.Item className="d-flex" onClick={()=>auth.logOut()} ><i className="ti ti-logout fs-18 me-2 op-7"></i>Log Out</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        <div className="header-element">
            ...
            <Modal className="modal fade" id="searchModal" tabIndex={-1} aria-labelledby="searchModal" aria-hidden="true" show={show} onHide={handleClose}>
                <Modal.Body>
                    <div className="input-group">
                        ...
                        <Form.Control type="search" className="form-control border-0 px-2" placeholder="Search" aria-label="Username"
                            autoComplete="off"/>
